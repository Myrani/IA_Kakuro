...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, datahandler, parent=None):
        ...
        self.filterSettings = []
        self.dictionnaire = self.datahandler.loadSums()
    ...
    def startCreatorWindow(self):
        self.creatorWindow = Creator_Window.CreatorWindow(
            self.creatorKakuro, self.datahandler, parent=self)
    ...
    def startLoaderWindow(self):
        self.loaderWindow = Loader_Window.LoaderWindow(
            self.datahandler, parent=self)
