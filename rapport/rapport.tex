...
\subsection{Back-end}
Le code présent dans le repertoire back-end constitue le coeur du logiciel. Il correspond aux methodes qui vont permettre de créer un grille, y associer des valeurs à jouer ou  encore une "heat map". 
